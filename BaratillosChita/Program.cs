...
namespace BaratillosChita
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            productos.Add(new Producto("147548", "Plumones Sharpie\t", 05, 65.3, 450, new DateTime(2020, 07, 20), new DateTime(2020, 12, 31), 85.5));
            productos.Add(new Producto("258969", "Pringles Original\t", 04, 30, 400, new DateTime(2020, 10, 12), new DateTime(2020, 12, 25), 65.30));
            productos.Add(new Producto("258969", "SOUR PATCH Kids\t", 04, 50, 383, new DateTime(2020, 08, 26), new DateTime(2020, 12, 15), 100));
            ...
            productos.Add(new Producto("159604", "Crema NIVEA Milk Nutrive\t", 02, 43.6, 224, new DateTime(2020, 12, 12), new DateTime(2020, 12, 31), 60.8));
            ...
            productos.Add(new Producto("642819", "Blusa de tirantes verde\t", 01, 38.4, 100, new DateTime(2020, 8, 12), new DateTime(2020, 12, 05), 72.15));
